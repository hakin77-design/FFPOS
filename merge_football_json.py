...
print('=== MERGING FOOTBALL.JSON DATA ===\n')

# Load existing teams
print('1. Loading existing teams...')
with open('data/teams.json', 'r', encoding='utf-8') as f:
    teams = json.load(f)
print(f'   Current teams: {len(teams)}')

# Load football.json matches
print('\n2. Loading football.json matches...')
with open('data/football_json_matches.json', 'r', encoding='utf-8') as f:
...
print('\n4. Merging with existing database...')
new_teams = 0
updated_teams = 0
...
for team_name, stats in team_stats.items():
    ...
    # Calculate metrics
    attack = (stats['goals_scored'] / stats['matches']) * 20
    defense = 100 - ((stats['goals_conceded'] / stats['matches']) * 20)
...
sample_teams = ['manchesterutd', 'liverpool', 'arsenal', 'chelsea', 'manchestercity']
